...
public class vehicle {
    ...
    private String status; // Added field for availability status

    public vehicle(String vType, String vModelName, String vBrand, int noOfSeats, double price, String ownerId) {
